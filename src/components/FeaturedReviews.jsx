            ...
            <div className="container-responsive mx-auto">
                ...
                <div className="mb-10 px-2">
                    ...
                    <div className="flex justify-between items-end">
                        ...
                        <Link to="/reviews" className="text-[9px] md:text-[10px] font-black uppercase tracking-widest border-b border-zinc-200 pb-1 hover:border-black hover:text-zinc-600 transition-all flex items-center gap-1">
