        ...
        <section className="bg-zinc-50 py-12 md:py-24 border-t border-zinc-200">
            ...
            <div className="max-w-[1440px] mx-auto px-6 md:px-24">
                ...
                <div className="mb-12 px-2">
                    <h2 className="text-2xl md:text-5xl font-black uppercase tracking-tighter whitespace-nowrap mb-1">Customer Reviews</h2>
                    <div className="flex flex-row justify-between items-center gap-4">
                        <p className="text-[8px] md:text-[10px] text-zinc-400 font-bold uppercase tracking-widest whitespace-nowrap">What our community says</p>
