...
import { X, ShoppingBag, Heart, Star, Zap, Truck, ShieldCheck, Loader2 } from 'lucide-react';
                    ...
                    {product.variants?.length > 0 && (
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {[...new Set(product.variants.filter(v => v.color === selectedColor).map(v => v.size))].map((size, i) => (
                                        <button
                                            key={i}
