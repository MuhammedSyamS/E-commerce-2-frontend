...
const ProductCard = ({ product, onAddToCart }) => {
  ...
  return (
    <div className="group/card relative w-full md:max-w-[260px] transition-all duration-500 hover:-translate-y-2 md:overflow-visible">
      {/* IMAGE CONTAINER */}
      <div className="relative w-full aspect-[4/5] overflow-hidden bg-zinc-50 border border-zinc-100 mb-3 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-500">
