...
const FlashSaleBanner = () => {
    const { flashSale, fetchFlashSale } = useStore();
    const [timeLeft, setTimeLeft] = useState(null);

    useEffect(() => {
        fetchFlashSale();
        const interval = setInterval(fetchFlashSale, 60000); // Re-check every minute
        ...
        <div className="bg-gradient-to-r from-red-600 to-red-700 text-white overflow-hidden relative">
            ...
            <div className="max-w-[1440px] mx-auto px-4 md:px-12 py-3 flex flex-col md:flex-row items-center justify-between relative z-10 gap-2 md:gap-8">
                ...
                <div className="flex items-center gap-4 md:gap-6">
                    ...
                    <Link to="/shop" className="bg-white text-red-600 px-4 py-2 rounded-full text-[10px] font-black uppercase tracking-widest hover:bg-black hover:text-white transition-colors flex items-center gap-2">
