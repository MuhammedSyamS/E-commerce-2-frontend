          ...
          >
            ...
            <div className="relative space-y-2">
              ...
              <h1 className="text-3xl md:text-5xl font-black tracking-tighter text-zinc-900 flex items-center gap-3">
                Inbox
                {unreadCount > 0 && (
                  <span className="inline-flex items-center justify-center px-3 py-1 bg-red-600 text-white text-[10px] md:text-xs font-black rounded-full shadow-lg shadow-red-200 animate-pulse">
                    {unreadCount} NEW
                  </span>
                )}
              </h1>
