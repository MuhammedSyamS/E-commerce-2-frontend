...
const AdminUsers = () => {
    ...
    const updateRoleDirectly = async (userToUpdate, value) => {
        try {
            ...
            if (userToUpdate._id === user._id) {
                // We need to keep the token and other fields, just update role/permissions/isAdmin
    ...
    if (loading) return <div className="text-[10px] font-bold uppercase tracking-widest text-zinc-400">Loading Users...</div>;

    return (
        <div>
            <div className="flex justify-between items-end mb-12">
                <div>
                    <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-zinc-400 mb-2">Team & Customers</p>
                    <h1 className="text-2xl font-black uppercase italic tracking-tighter">User <span className="text-zinc-300">Management</span></h1>
                </div>
                <div className="relative">
                    ...
                    <input
                        ...
                        className="pl-12 pr-4 py-3 rounded-xl bg-white border border-transparent focus:border-black outline-none text-xs font-bold uppercase shadow-sm w-64 transition-all"
                    />
                </div>
            </div>
