...
import { MessageSquare, Star, Trash2, Eye, EyeOff, MessageCircle, X, Search, Quote } from 'lucide-react'; // Added Search, Quote
                                ...
                                {item.review.images && item.review.images.length > 0 && (
                                    <div className="flex gap-2 mt-3 pl-8">
                                        {item.review.images.map((img, i) => (
                                            <img key={i} src={img} className="w-10 h-10 rounded-lg object-cover border border-zinc-100" alt="review" />
                                        ))}
                                    </div>
                                )}
                            </div>
