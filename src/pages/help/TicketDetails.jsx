    ...
    return (
        <div className="min-h-screen bg-zinc-50 pt-40 pb-20 px-6">
            <div className="max-w-3xl mx-auto">
                <Link to="/support-tickets" className="flex items-center gap-2 text-zinc-400 text-[10px] font-black uppercase tracking-widest hover:text-black mb-8 transition-colors">
                ...
                <div className="bg-white rounded-3xl shadow-lg overflow-hidden border border-zinc-100">
                    ...
                    <div className="p-8 border-b border-zinc-100 bg-zinc-50/50">
                        ...
                        <h1 className="text-2xl font-black uppercase italic tracking-tighter mb-2">{ticket.subject}</h1>
