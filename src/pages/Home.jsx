              ...
              <div key={slide.id} className={`absolute inset-0 transition-opacity duration-1000 ${index === currentSlide ? "opacity-100 z-10" : "opacity-0 z-0"}`}>
                ...
                <div className="absolute inset-0 flex items-center justify-center px-6 z-20">
                  <div className="text-center">
                    ...
                    <h2 className="text-white text-4xl md:text-6xl lg:text-8xl font-black uppercase tracking-tighter mb-10 leading-tighter">{slide.title}</h2>
            ...
            <Reveal width="100%" delay={idx * 0.1}>
              <section id={section.id} className={`container-responsive py-12 md:py-24 relative ${section.bg} ${activeView !== 'all' ? 'pt-40' : ''}`}>
                <div className="flex justify-between items-end mb-12">
                  <div>
                    <h2 className="text-2xl md:text-4xl lg:text-5xl font-black uppercase tracking-tighter">{section.title}</h2>
                    <p className="text-[10px] text-zinc-400 font-bold uppercase tracking-widest mt-1">{section.subtitle}</p>
                  </div>
      ...
      {activeView === 'all' && (
        <Reveal width="100%">
          <section className="container-responsive py-12 md:py-24 relative bg-white border-t border-zinc-100">
            <div className="flex justify-between items-end mb-12">
              <div>
                <h2 className="text-2xl md:text-4xl lg:text-5xl font-black uppercase tracking-tighter">Styled by You</h2>
                <p className="text-[10px] text-zinc-400 font-bold uppercase tracking-widest mt-1">Community Curation #StyledBySLOOK</p>
              </div>
          ...
          <section className="container-responsive py-12 md:py-24 bg-zinc-950 text-white overflow-hidden relative rounded-[3rem] mb-12">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-8 relative z-10 px-8">
              <div className="space-y-4">
                <p className="text-amber-500 text-[10px] font-black uppercase tracking-mega">Elite Rewards</p>
                <h2 className="text-4xl md:text-6xl lg:text-8xl font-black uppercase tracking-tighter leading-none">Loyalty <br /> <span className="text-zinc-800">Milestones.</span></h2>
              </div>
