              ...
              <div key={slide.id} className={`absolute inset-0 transition-opacity duration-1000 ${index === currentSlide ? "opacity-100 z-10" : "opacity-0 z-0"}`}>
                ...
                <div className="absolute inset-0 flex items-center justify-center px-6 z-20">
                  <div className="text-center">
                    <p className="text-white/80 text-sm md:text-base font-black uppercase tracking-[0.8em] mb-6">{slide.subtitle}</p>
                    <h2 className="text-white text-3xl md:text-7xl font-black uppercase tracking-[0.05em] mb-10 leading-tight">{slide.title}</h2>
                    <button onClick={scrollToProducts} className="bg-white text-black px-12 py-4 text-base md:text-[10px] font-black uppercase tracking-[0.4em] hover:bg-black hover:text-white transition-all duration-500 cursor-pointer">Explore SLOOK</button>
                  </div>
                </div>
              ...
              <section id={section.id} className={`container-responsive py-12 md:py-24 relative ${section.bg} ${activeView !== 'all' ? 'pt-40' : ''}`}>
                <div className="flex justify-between items-end mb-12">
                  <div>
                    ...
                    <p className="text-sm md:text-[10px] text-zinc-400 font-bold uppercase tracking-widest mt-2">{section.subtitle}</p>
                  </div>
                  <Link to={section.link} className="text-sm md:text-[10px] font-black uppercase tracking-[0.2em] border-b border-zinc-200 pb-1 hover:border-black hover:text-zinc-600 transition-all">View All</Link>
                </div>
      ...
      {activeView === 'all' && (
        <Reveal width="100%">
          <section className="container-responsive py-12 md:py-24 relative bg-white border-t border-zinc-100">
            <div className="flex justify-between items-end mb-12">
              <div>
                <h2 className="text-xl md:text-5xl font-black uppercase tracking-tighter">Styled by You</h2>
                <p className="text-sm md:text-[10px] text-zinc-400 font-bold uppercase tracking-widest mt-2">Community Curation #StyledBySLOOK</p>
              </div>
              <Link to="/looks" className="text-sm md:text-[10px] font-black uppercase tracking-[0.2em] border-b border-zinc-200 pb-1 hover:border-black hover:text-zinc-600 transition-all">View All Looks</Link>
            </div>
          ...
          <section className="container-responsive py-12 md:py-24 bg-zinc-950 text-white overflow-hidden relative rounded-[3rem] mb-12">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-8 relative z-10 px-8">
              <div className="space-y-4">
                <p className="text-amber-500 text-sm md:text-[10px] font-black uppercase tracking-[0.4em]">Elite Rewards</p>
                <h2 className="text-3xl md:text-7xl font-black uppercase tracking-tighter leading-[0.9]">Loyalty <br /> <span className="text-zinc-800">Milestones.</span></h2>
              </div>
