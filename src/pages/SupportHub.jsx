        ...
        <div className="bg-white min-h-screen pt-44 md:pt-52 pb-20">
            ...
            <div className="container mx-auto px-6 max-w-4xl">
                <div className="text-center mb-16">
                    <h1 className="text-4xl md:text-6xl font-black uppercase tracking-tighter italic transform -skew-x-3 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
                    {[
                        ...
                        { icon: <Mail />, title: "Email Us", sub: "support@slook.com", action: "Send Email", color: "bg-amber-50 text-amber-600" },
                ...
                <div className="mt-20 p-10 bg-black rounded-[2.5rem] text-center text-white relative overflow-hidden">
                    ...
                    <h2 className="text-2xl font-black uppercase italic mb-4">Still need help?</h2>
